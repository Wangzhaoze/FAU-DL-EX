...
class TestGen(unittest.TestCase):
    ...
    def testResetIndex(self):
        # Data contains 100 image samples, for a batch size of example 60 an
    ...
    def testRotation(self):
        ...
        # extract corner points for each sample and reduce augmented to one characteristic row
        ...
        # subtract characteristic corners to original corners. after summing spacial and channel dimensions,
        # 0 are expected e.g. if sample 2 is rotated by 90, we have a 0 in rot1 at the 2nd position see similar to
        # testMirroring
